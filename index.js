  ...
  var createHeaderElement = function createHeaderElement(data) {
    ...
    */
    ...
    var createSizeElement = function createSizeElement(dropDown, sizeInfo) {
      var onlyFive = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    ...
    */
    ...
    insertElement('.kam_header-info_reserve', replaceText(data.productReservation, 'Забронировать в магазине', 'ЗАБРАТЬ ЧЕРЕЗ ЧАС'));
